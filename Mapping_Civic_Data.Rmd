...
Jan Devereux (FPRA president, now City Councilor) suggested that FPRA might need a “data person”. I volunteered. 🙌

Coincidentally, [Leaflet for R](http://rstudio.github.io/leaflet/) was released around the same time. 
